...
help:
	...
	@echo "test-ci        : Runs tests for CI environment."
	@echo "coverage       : Runs tests with coverage report, and opens them."
...
test-ci:
	$(GOTEST) -race -shuffle=on -coverprofile=coverage.out ./...
